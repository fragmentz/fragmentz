...
Compiler.prototype.compileGrammar = function compileGrammar(ast) {
  ...
  // Prelude
	if( !this.grammarsRequired[parent] ) {
		this.grammarsRequired[parent] = true;
		this.enter('code', function() {
			// Enter chunks
			this.push([]);
			if( this.options.runtime ) {
				this.insert(
					'var '+parent+' = require("'+this.options.runtime+'/'+parent+'");'
				);
			} else {
				this.insert(
					'var '+parent+' = require("ometajs").grammars['+
