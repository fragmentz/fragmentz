...
var AbstractGrammar = require('./ometajs/runtime/grammar');
...
require("./ometajs/runtime/util").inherits(CSSParser, AbstractGrammar);
...
CSSParser.prototype["m_string1"] = function $m_string1() {
    var s;
...
CSSParser.prototype["m_string2"] = function $m_string2() {
    var s;
    return this._match("'") && this._any(function() {
        return this._atomic(function() {
            return this._atomic(function() {
...
CSSParser.prototype["string"] = function $string() {
    var x, x;
    return this._atomic(function() {
        return this._rule("m_string1", false, [], null, this["m_string1"]) && (x = this._getIntermediate(), true) && this._exec([ "string", x, '"' ]);
    }) || this._atomic(function() {
        return this._rule("m_string2", false, [], null, this["m_string2"]) && (x = this._getIntermediate(), true) && this._exec([ "string", x, "'" ]);
    });
};
